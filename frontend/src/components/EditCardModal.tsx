            ...
            <div className="mb-6">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  disabled={loading}
                  className="w-4 h-4 rounded border-2 border-pastel-blue-300 cursor-pointer accent-pastel-green-500"
                />
                <span className="text-sm font-semibold text-pastel-blue-900">
                  카드를 완료로 표시
                </span>
              </label>
            </div>
